...
WSGI_APPLICATION = 'TronoSeguro.wsgi.application'
...
if IS_TESTING:
    DATABASES = {
        "default": {
            ...
            "NAME": os.path.join(BASE_DIR, "testing.postgresql_psycopg2"),
        }
    }
else:

    options = {}
    if os.environ.get("DB_ENGINE") == "django.db.backends.postgresql_psycopg2":
        options = {
        }
...
JAZZMIN_SETTINGS = {
    # Text
    "site_title": "Nombre Genérico",
    "site_header": "Admin",
    "site_brand": "Nombre Genérico",
    "welcome_sign": "Bienvenido a Nombre Genérico",
    "copyright": "Angel Cruz",
